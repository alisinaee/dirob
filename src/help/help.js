(function () {
  ...
  const translations = {
    fa: {
      ...
      whatBody: "Rashnu هنگام مرور صفحات لیست و جزئیات محصول در <strong>دیجیکالا</strong>، <strong>ترب</strong> و <strong>تکنولایف</strong>، نتیجه‌ی مقایسه را برای چندین فروشگاه از جمله ایمالز، آمازون و eBay در پنل کناری نمایش می‌دهد.",
      ...
      featuresList: "<li>مقایسه قیمت بین چندین فروشگاه</li><li>شماره‌گذاری راهنما روی صفحه و داخل پنل</li><li>پرش از پنل به محصول روی صفحه و برعکس</li><li>همگام‌سازی با آیتم قابل مشاهده در صفحه</li><li>نمای لیست یا گرید، به‌همراه نمای مینیمال</li>",
      settingsTitle: "تنظیمات",
      settingsList: "<li><strong>انتخاب عنصر</strong>: فقط محصولی که روی آن hover یا focus می‌شود بررسی و نمایش داده می‌شود.</li><li><strong>همگام با دید صفحه</strong>: پنل سعی می‌کند آیتمی را برجسته کند که کاربر واقعاً در صفحه می‌بیند.</li><li><strong>نمای مینیمال</strong>: کارت‌ها فشرده‌تر می‌شوند و دکمه‌های هر آیتم به حالت آیکونی درمی‌آیند.</li><li><strong>شماره راهنما</strong>: کنار هر محصول روی سایت، یک شماره می‌افتد که همان شماره در Rashnu هم دیده می‌شود.</li><li><strong>دیباگ</strong>: داده‌های تشخیصی و جزئیات بیشتری در پنل نشان می‌دهد.</li><li><strong>ثبت خودکار لاگ</strong>: وقایع توسعه را به لاگ محلی می‌فرستد.</li><li><strong>چیدمان</strong>: بین لیست و گرید جابه‌جا می‌شود.</li><li><strong>اندازه</strong>: مقیاس کلی پنل را کم یا زیاد می‌کند.</li><li><strong>هشدار آمازون و eBay</strong>: آمازون و eBay ممکن است ترافیک افزونه را به‌عنوان رفتار بات تشخیص دهند، بنابراین نتایج این دو منبع همیشه کاملاً قابل اتکا نیست.</li>",
    ...
    en: {
      ...
      whatBody: "Rashnu watches listing and product-detail pages on <strong>Digikala</strong>, <strong>Torob</strong>, and <strong>Technolife</strong>, then shows multi-provider comparison results (including Emalls, Amazon, and eBay) in the side panel.",
